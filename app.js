...
app.get("/all/:city", rateLimiter, function (req, res) {
   ...
   */
    ...
    */
    ...
    res.render("home", { finalData: finalData });
  });
});
/*
...
/*
    var maxTempCel=dataa.f.forecastday[0].day.maxtemp_c;
    var minTempCel=dataa.f.forecastday[0].day.mintemp_c
    var maxTempFar=dataa.f.forecastday[0].day.maxtemp_f;
    var minTempFar=dataa.f.forecastday[0].day.mintemp_f;
    var avgTempCel=dataa.f.forecastday[0].day.avgtemp_c;
    var avgTempFar=dataa.f.forecastday[0].day.avgtemp_f;
*/
